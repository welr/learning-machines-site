...
$\text{MSE} = \frac{1}{m}\sum_i (y_i - \hat{y}_i)^2$.
...
Push the degree to $m - 1 = 14$ and the polynomial passes *exactly* through all fifteen
...
to more than a million at the interpolating degree 14. This explosion is exactly what the ridge
and LASSO penalties of Chapter 7 are built to prevent.

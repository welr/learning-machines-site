...
par(mfrow = c(1, 2))
plot(seq_len(n_steps), losses, type = "l", col = "#076FA1", lwd = 2.5, bty = "l",
...
par(mfrow = c(1, 2))
plot(z, sigmoid(z), type = "l", col = "#076FA1", lwd = 2, ylim = c(-1.5, 4), bty = "l",
...
plot(z, sig_d(z), type = "l", col = "#076FA1", lwd = 2, ylim = c(-0.1, 1.2), bty = "l",

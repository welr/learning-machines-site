...
<img src="../figures/ch10_02_applied.png" alt="Left, a 4-by-4 grid of the sixteen 3-by-3 first-layer convolution filters after training, small red-blue tiles with no visible edge structure. Right, a row of eight Fashion-MNIST test images with the trained model's predicted class and confidence printed above each, six labeled in blue for correct and two in red for wrong: a T-shirt called a shirt at 69 percent and a coat called a pullover at 52 percent.">

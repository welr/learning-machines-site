...
rows, the actual classes across the columns. Most software, scikit-learn included,
prints the transpose, with the actual classes down the rows.
...
print(f"pred 0   |    {TN:5d}     {FN:5d}    (TN, FN)")
print(f"pred 1   |    {FP:5d}     {TP:5d}    (FP, TP)")
...
cat("            actual 0   actual 1\n")
cat(sprintf("pred 0   |    %5d     %5d    (TN, FN)\n", TN, FN))
cat(sprintf("pred 1   |    %5d     %5d    (FP, TP)\n", FP, TP))

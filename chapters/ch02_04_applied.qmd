---
title: "Applied — Regression on Real Data"
engine: markdown
---
...
::: {.explore}
[Try it]{.lbl}
Refit `mpg` on horsepower instead of weight, or on weight *and* model year (`mtcars$wt` and `mtcars$qsec` are stand-ins you can swap in), and ask whether the extra feature earns its place. Then push the polynomial degree past 10 and watch the heavy-end wriggle turn violent.
:::
